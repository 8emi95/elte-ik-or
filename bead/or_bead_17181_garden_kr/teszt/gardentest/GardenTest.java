...
public class GardenTest {
    ...
    public void testPlayerCount2() throws Exception {
        ...
        //playStandardGame(2, 2, "input1.txt", "GardenStore.txt", "GardenStore1_mo.txt");
    }
    /*
    @Test(timeout=4000)
    ...
    /*public void playStandardGame(int serverPlayerCount, int realPlayerCount, String inputFilename, String outputFilename, String sampleOutputFilename
		, String[] customerParams, String[] gardenerParams)
            throws InterruptedException, IOException {
        // DominoServer elinditasa
        /*runMain(1,
                args -> GardenStore.main(args),
                /*n -> realPlayerCount+" "+outputFilename* /new String[] {outputFilename}, 
		"GS");
        ...
        runMain(realPlayerCount,
                ...
                /*n -> "Customer" + n+" "+n+" "+ n+2* /customerParams,
		"C"
                );
	...
	runMain(realPlayerCount,
                ...
                /*n -> "Gardener" + n+" "+ n+1* /gardenerParams,
		"G"
                );
   ...
   // }
    ...
    public void runMain(int count, ConsumerEx<String[]> main, String[][] args, String threadNamePrefix) {
        for (int i = 0; i < count; i++) {
            String[] serverArgs = args[i];
